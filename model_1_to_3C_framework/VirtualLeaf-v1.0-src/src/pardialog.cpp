...
// add the first four widgets with (row, column) addressing
  ...
  grid->addWidget( new QLabel( "i1 division if cle41> ", this ),22, 6 );
  grid->addWidget( i1_edit, 22, 6+1  );
  grid->addWidget( new QLabel( "i2 division if cle46<", this ),23, 6 );
  grid->addWidget( i2_edit, 23, 6+1  );
  grid->addWidget( new QLabel( "i3 into phloem if cle41>", this ),24, 6 );
  grid->addWidget( i3_edit, 24, 6+1  );
  grid->addWidget( new QLabel( "i4 into xylem if cle46>", this ),25, 6 );
...
QString tmpval;
  ...
  par.i1 = i1_edit->text().toDouble();
  par.i2 = i2_edit->text().toDouble();
  par.i3 = i3_edit->text().toDouble();
  par.i4 = i4_edit->text().toDouble();
  par.i5 = i5_edit->text().toDouble();
