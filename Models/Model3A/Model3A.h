/*
 *  $Id: Model3A.h,v 6bcb69712a0e 2010/11/24 17:02:13 roeland $
 *
...
class Model3A : public QObject, SimPluginInterface {
	Q_OBJECT
	Q_INTERFACES(SimPluginInterface);
	Q_PLUGIN_METADATA(IID "org.virtualleaf.Model3A")
...
public:
   ...
   virtual QString DefaultLeafML(void) {return QString("hypo7_model3A.xml");}
};
