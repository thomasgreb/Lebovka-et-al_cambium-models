...
QString Model3D::ModelID(void) { return QString( "Model 3D" ); }
...
// 2 -> 9
// 3 -> 10
int Model3D::NChem(void) { return 11; }
...
void Model3D::CellHouseKeeping(CellBase *c) {
    ...
    //c->SetChemical(2, par->k3); // this is the relevant chemical for the cell wall dynamics
