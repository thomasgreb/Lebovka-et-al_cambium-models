/*
 *  $Id: Model3C.h,v 6bcb69712a0e 2010/11/24 17:02:13 roeland $
 *
...
class Model3C : public QObject, SimPluginInterface {
	Q_OBJECT
	Q_INTERFACES(SimPluginInterface);
	Q_PLUGIN_METADATA(IID "org.virtualleaf.Model3C")
...
public:
   ...
   virtual QString DefaultLeafML(void) {return QString("hypo7_model3C.xml");}
};
