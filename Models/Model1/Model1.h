/*
 *  $Id: Model1.h,v 6bcb69712a0e 2010/11/24 17:02:13 roeland $
 *
...
class Model1 : public QObject, SimPluginInterface {
	Q_OBJECT
	Q_INTERFACES(SimPluginInterface);
    Q_PLUGIN_METADATA(IID "org.virtualleaf.Model1")

public:
	virtual QString ModelID(void) {return QString("Model 1");}
	...
	virtual int NChem(void) { return 8; }

   virtual QString DefaultLeafML(void) {return QString("hypo7_model1.xml");}
};
