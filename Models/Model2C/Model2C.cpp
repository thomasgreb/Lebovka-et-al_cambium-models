...
QString Model2C::ModelID(void) {
    // specify the name of your model here
    return QString( "Model 2C" );
}

// return the number of chemicals your model uses
int Model2C::NChem(void) { return 8; }

// To be executed after cell division
void Model2C::OnDivide(ParentInfo *parent_info, CellBase *daughter1, CellBase *daughter2) {
...
void Model2C::SetCellColor(CellBase *c, QColor *color) {
...
void Model2C::CellHouseKeeping(CellBase *c) {
...
void Model2C::CelltoCellTransport(Wall *w, double *dchem_c1, double *dchem_c2) {
...
void Model2C::WallDynamics(Wall *w, double *dw1, double *dw2) {
    // add biochemical networks for reactions occuring at walls here
}
void Model2C::CellDynamics(CellBase *c, double *dchem) {
	...
	if(c->CellType()==0) {
		...
		else
		{
            ...
            //free-pxy is produced, consumed by pxy binding and is degraded
            dchem[1] =  -  1 * c->Chemical(0) * c->Chemical(1) - par->k[3] * c->Chemical(1); // model 2C
            //dchem[1] = 0.1* (1 /(1 + 100*c->Chemical(2)))  -  1 * c->Chemical(0) * c->Chemical(1) - par->k[3] * c->Chemical(1); // model 2D
