/*
 *  $Id: Model2B.h,v 6bcb69712a0e 2010/11/24 17:02:13 roeland $
 *
...
class Model2B : public QObject, SimPluginInterface {
	Q_OBJECT
	Q_INTERFACES(SimPluginInterface);
	Q_PLUGIN_METADATA(IID "org.virtualleaf.Model2B")
...
public:
   ...
   virtual QString DefaultLeafML(void) {return QString("hypo7_model2B.xml");}
};
