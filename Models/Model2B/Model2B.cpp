...
QString Model2B::ModelID(void) {
    // specify the name of your model here
    return QString( "Model 2B" );
}

// return the number of chemicals your model uses
int Model2B::NChem(void) { return 8; }

// To be executed after cell division
void Model2B::OnDivide(ParentInfo *parent_info, CellBase *daughter1, CellBase *daughter2) {
...
void Model2B::CellHouseKeeping(CellBase *c) {
...
void Model2B::CellDynamics(CellBase *c, double *dchem) {
