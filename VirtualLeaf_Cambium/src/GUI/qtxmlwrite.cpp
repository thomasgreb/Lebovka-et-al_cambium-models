...
void Cell::XMLAddCore(QDomDocument &doc, QDomElement &xmlcell) const {
...

  {
      //ostringstream text;
      //text << par_index;
      xmlcell.setAttribute("par_index",standardlocale.toString(par_index));
  }
  {
  //  ostringstream text;
  //  text << target_area;
 ...
 //   xmlNewProp(xmlcell, BAD_CAST "pin_fixed", BAD_CAST text.str().c_str());
...

  {
   ...
   // text << cell_type;
   // xmlNewProp(xmlcell, BAD_CAST "cell_type", BAD_CAST text.str().c_str());
         xmlcell.setAttribute("centr_x",standardlocale.toString(Centroid().x));
  }

  {
   ...
   // text << cell_type;
   // xmlNewProp(xmlcell, BAD_CAST "cell_type", BAD_CAST text.str().c_str());
         xmlcell.setAttribute("centr_y",standardlocale.toString(Centroid().y));
  }
