...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_OptionFileDialog_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_OptionFileDialog_t qt_meta_stringdata_OptionFileDialog = {
    {
QT_MOC_LITERAL(0, 16) // "OptionFileDialog"
...
QT_INIT_METAOBJECT const QMetaObject OptionFileDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_OptionFileDialog.offsetsAndSize,
