...
class CellBase :  public QObject, public Vector 
{
 ...
 public:
  ...
  double CalcLumenArea(void) const; //Lebovka et al
  double CalcLigniArea(void) const; //Lebovka et al

  double RecalcArea(void) { return area = CalcArea(); }
  double RecalcLumenArea(void) { return lum_area = CalcLumenArea(); } //Lebovka et al

  Vector Centroid(void) const;

  void SetIntegrals(void) const;
  double Width(void) const; // Lebovka et al
  ...
  double ExactLumenCircumference(void); // Lebovka et al
  double ExactLigniCircumference(void); // Lebovka et al
 ...
 protected:
  ...
  mutable double area;
  mutable double lum_area; //Lebovka et al
  double target_area;
