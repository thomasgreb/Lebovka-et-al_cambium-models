...
QString Model3B::ModelID(void) {
  // specify the name of your model here
  return QString( "Model 3B" );
}

// return the number of chemicals your model uses
int Model3B::NChem(void) { return 9; }

// To be executed after cell division
void Model3B::OnDivide(ParentInfo *parent_info, CellBase *daughter1, CellBase *daughter2) {
...
void Model3B::SetCellColor(CellBase *c, QColor *color) { 
...
void Model3B::CellHouseKeeping(CellBase *c) {
...
void Model3B::CelltoCellTransport(Wall *w, double *dchem_c1, double *dchem_c2) {
...
void Model3B::WallDynamics(Wall *w, double *dw1, double *dw2) {
  // add biochemical networks for reactions occuring at walls here
}


void Model3B::CellDynamics(CellBase *c, double *dchem) { 
