...
QString Model3D_fitting::ModelID(void) { return QString( "Model 3D for Fitting" ); }


int Model3D_fitting::NChem(void) { return 9; }

// To be executed after cell division
void Model3D_fitting::OnDivide(ParentInfo *parent_info, CellBase *daughter1, CellBase *daughter2) {
...
void Model3D_fitting::SetCellColor(CellBase *c, QColor *color) { 
    double i2 = 0.0001;
	double i3 = 1;
    double i4 = 0.0001;
...
*/
void Model3D_fitting::CellHouseKeeping(CellBase *c) {
      //cout << c->Index() << "\t" <<
              //c->CellType() << "\t" <<
              //c->Area() << "\t" <<
              //c->CalcLumenArea() << "\t" <<
	...
	// phloem parenchyma
        ...
        // switch k3 for k0 for final simulations
...
void Model3D_fitting::CelltoCellTransport(Wall *w, double *dchem_c1, double *dchem_c2) {
...
void Model3D_fitting::WallDynamics(Wall *w, double *dw1, double *dw2) {
  // add biochemical networks for reactions occuring at walls here
}
void Model3D_fitting::CellDynamics(CellBase *c, double *dchem) { 
