...
QString Model3A::ModelID(void) {
  // specify the name of your model here
  return QString( "Model 3A" );
}

// return the number of chemicals your model uses
int Model3A::NChem(void) { return 9; }

// To be executed after cell division
void Model3A::OnDivide(ParentInfo *parent_info, CellBase *daughter1, CellBase *daughter2) {
...
void Model3A::SetCellColor(CellBase *c, QColor *color) { 
...
void Model3A::CellHouseKeeping(CellBase *c) {
...
void Model3A::CelltoCellTransport(Wall *w, double *dchem_c1, double *dchem_c2) {
...
void Model3A::WallDynamics(Wall *w, double *dw1, double *dw2) {
  // add biochemical networks for reactions occuring at walls here
}


void Model3A::CellDynamics(CellBase *c, double *dchem) { 
