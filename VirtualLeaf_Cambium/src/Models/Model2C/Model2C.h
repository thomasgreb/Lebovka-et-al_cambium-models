/*
 *  $Id: Model2C.h,v 6bcb69712a0e 2010/11/24 17:02:13 roeland $
 *
...
class Model2C : public QObject, SimPluginInterface {
	Q_OBJECT
	Q_INTERFACES(SimPluginInterface);
    Q_PLUGIN_METADATA(IID "org.virtualleaf.Model2C")
...
public:
   ...
   virtual QString DefaultLeafML(void) {return QString("C:/Users/Ruth/Documents/VirtualLeaf_Cambium/VirtualLeaf_Cambium/data/leaves/hypo7_model2C.xml");}
};
