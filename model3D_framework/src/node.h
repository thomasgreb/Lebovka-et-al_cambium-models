...
class Node : public Vector {
 ...
 public:
  ...
  inline double getmcsx(void) const {return mcsx; }
  inline void setmcsx(double new_mcss) {mcsx = new_mcss; }

  inline double getmcsy(void) const {return mcsy; }
  inline void setmcsy(double new_mcss) {mcsy = new_mcss; }
